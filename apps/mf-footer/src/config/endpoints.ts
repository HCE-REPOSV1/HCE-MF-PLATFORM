/**
 * ---------------------------------------------------------
 * Endpoints centralizados — mf-footer
...
if (!AG_CROSS) throw new Error("[mf-footer] VITE_APIGW_CNL_CROSS no está configurado")

export const ENDPOINTS = {

  /** i18n — manifest público; namespace "footer" protegido (requiere sesión) */
  i18n: {
