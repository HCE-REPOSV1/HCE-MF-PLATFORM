  ...
  return (
    <Box>
      ...
      <HceModal
        ...
        testId="mf-triage-patient-not-found-modal"
      />
      <HceModal
        maxWidth={460}
        open={!!loadError}
        ...
        testId="mf-triage-load-error-modal"
      />
      <HceModal
        maxWidth={460}
        open={!!saveError}
        ...
        testId="mf-triage-save-error-modal"
      />
      <HceModal
        maxWidth={460}
        ...
        testId="mf-triage-confirm-close-modal"
      />
      <HceFormModal
        ...
        secondaryButton={{
          label: readOnly
            ? t("actions.cancel.readonly")
            : t("actions.cancel.editable"),
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
            ...
            >
              <Box>
                <SelectField
                  ...
                  placeholder={t(
                    "triage.pacientInfo.firstBox.documentType.placeholder",
                  )}
                  disabled={
                    form.noIdentificado ||
                  ...
                  testId="mf-triage-document-type"
                />
              </Box>
              <Box sx={{ flex: 1, minWidth: 140 }}>
                <TextInput
                  ...
                  placeholder={t(
                    "triage.pacientInfo.firstBox.documentNumber.placeholder",
                  )}
                  disabled={
                    form.noIdentificado ||
                    !canDatosPacienteTriage ||
                  ...
                  testId="mf-triage-document-number"
                />
              </Box>
              {/* Botón buscar  */}
              <IconButton
                ...
                testId="mf-triage-search-patient"
              ></IconButton>
              ...
              >
                <Checkbox
                  ...
                  testId="mf-triage-no-identifier"
                ></Checkbox>
              </Box>
            </Box>
            ...
            {form.noIdentificado ? (
              ...
              >
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <FieldCol
                    label={t("triage.pacientInfo.firstBox.documentLabel")}
                  >
                    <TextInput
                      value="NI"
                      disabled
                      onChange={() => {}}
                      testId="mf-triage-ni-document-type"
                    />
                  </FieldCol>
                </Grid>
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <FieldCol
                    label={t(
                      "triage.pacientInfo.firstBox.documentNumber.title",
                    )}
                  >
                    <TextInput
                      value={t(
                        "triage.pacientInfo.firstBox.placeholderDocument",
                      )}
                      disabled
                      onChange={() => {}}
                      testId="mf-triage-ni-document-number"
                    />
                  </FieldCol>
                </Grid>
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <SelectField
                    ...
                    placeholder={t(
                      "triage.pacientInfo.secondBox.genderPlaceholder",
                    )}
                    testId="mf-triage-ni-gender"
                  />
                </Grid>
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <SelectField
              ...
              >
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <TextInput
                    ...
                    placeholder={t(
                      "triage.pacientInfo.secondBox.firstName.placeholder",
                    )}
                    disabled={disableNombres}
                    testId="mf-triage-first-name"
                  />
                </Grid>
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <TextInput
                    ...
                    placeholder={t(
                      "triage.pacientInfo.secondBox.lastName.placeholder",
                    )}
                    disabled={disableApellidoPaterno}
                    testId="mf-triage-last-name"
                  />
                </Grid>
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <TextInput
                    label={t(
                      "triage.pacientInfo.secondBox.secondLastName.title",
                    )}
                    value={form.apellidoMaterno}
                    onChange={(v) => set("apellidoMaterno", v)}
                    placeholder={t(
                      "triage.pacientInfo.secondBox.secondLastName.placeholder",
                    )}
                    disabled={disableApellidoMaterno}
                    testId="mf-triage-second-last-name"
                  />
                </Grid>
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  {pacienteNoEncontrado ? (
                    <TextInput
                      ...
                      placeholder={t(
                        "triage.pacientInfo.secondBox.birthDate.placeholder",
                      )}
                      disabled={disableFechaNacimiento}
                      testId="mf-triage-birth-date"
                    />
                  ) : (
                    <DatePicker
                      label={t("triage.pacientInfo.secondBox.birthDate.title")}
                ...
                <Grid item xs={12} sm={6} md zeroMinWidth>
                  <SelectField
                    ...
                    options={genderOptions}
                    placeholder={t(
                      "triage.pacientInfo.secondBox.gender.placeholder",
                    )}
                    disabled={disableSexo}
                    testId="mf-triage-gender"
                  />
                </Grid>
              </Grid>
            )}
          ...
          <Box>
            <SectionHeader
              ...
              testId="mf-triage-section-clinical"
            />
            {expDatosClinicos && (
              <Box
                sx={{
              ...
              >
                ...
                <SearchComboInput
                  ...
                  placeholder={t(
                    "triage.clinicInfo.reasonOfAdmission.placeholder",
                  )}
                  testId="mf-triage-reason"
                />
                      ...
                      <FieldCol>
                        <Box sx={{ display: "flex", width: "100%" }}>
                          <SearchComboInput
                            ...
                            modePosition="right"
                            placeholder={t(
                              "triage.clinicInfo.timeOfIllness.placeholder",
                            )}
                            testId="mf-triage-illness-duration"
                          />
                        </Box>
                      </FieldCol>
                    </Box>
          ...
          <Box>
            <SectionHeader
              ...
              testId="mf-triage-section-vitals"
            />
            {expSignosVitales && (
              <Box>
                <Grid
                    ...
                    >
                      ...
                      <Grid item xs={12} sm={3} md={3} zeroMinWidth>
                        <NumericField
                          ...
                          testId="mf-triage-glasgow-total"
                        />
                      </Grid>
                    </Grid>
                  </Box>
                        ...
                        (key) => (
                          ...
                          >
                            <SelectField
                              ...
                              options={[
                                {
                                  value: t("triage.vitalSigns.fast.no"),
                                  label: t("triage.vitalSigns.fast.no"),
                                },
                                {
                                  value: t("triage.vitalSigns.fast.yes"),
                                  label: t("triage.vitalSigns.fast.yes"),
                                },
                              ]}
                              testId={`mf-triage-fast-${key}`}
                            />
                          </Grid>
                        ),
                      )}
          ...
          <Box>
            <SectionHeader
              ...
              testId="mf-triage-section-allergies"
            />
            {expAlergias && (
              <Box
                sx={{
              ...
              >
                ...
                <Box sx={{ mt: "20px" }}>
                  <TextareaField
                    ...
                    testId="mf-triage-food-allergies"
                  />
                </Box>
                <Box sx={{ mt: "20px" }}>
                  <TextareaField
                    ...
                    testId="mf-triage-other-allergies"
                  />
                </Box>
              </Box>
            )}
          ...
          <Box>
            <SectionHeader
              ...
              testId="mf-triage-section-classification"
            />
            {expTriaje && (
              <Box
                sx={{
